...
async function main() {
    ...
    const ignoredTargets = ignoreTargetsStr ? Set(ignoreTargetsStr.split(/, */g)) : Set();
    core.debug(`Ignored Targets: ${ignoreTargets}`);
    console.log(`Ignored Targets: ${ignoreTargets}`);
